...
local MoveBars = function()
    if not InCombatLockdown() then
        ...
        MultiBarBottomLeftButton1:SetPoint(
            "BOTTOMLEFT",
            ActionButton1,
            "TOPLEFT",
            0,
            ReputationWatchBar:IsShown() and 30 or 23
        )
        ...
        MultiBarBottomRightButton7:SetPoint(
            "BOTTOMLEFT",
            MultiBarBottomRightButton1,
            "TOPLEFT",
            0,
            ReputationWatchBar:IsShown() and 31 or 24
        )
...
local SetBarLength = function(shorten)
    ...
    if shorten then
        ...
        bar.t:SetTexture [[Interface/Addons/TheNightIsDarkUI/art/mainbar/ActionBarArtLarge]]
        ...
        bar.t:SetTexture [[Interface/Addons/TheNightIsDarkUI/art/mainbar/ActionBarArtSmall]]
...
local UpdatePetBar = function()
    ...
    if MODUI_VAR["elements"]["mainbar"].horiz and not MODUI_VAR["elements"]["mainbar"].enable then
        PetActionBarFrame:SetPoint(
            ...
            "TOPLEFT",
            20,
            MultiBarRight:IsShown() and 56 or MultiBarBottomLeft:IsShown() and 8 or -40
        )
        PetActionButton1:SetPoint(
            "BOTTOMLEFT",
            MultiBarBottomLeftButton1,
            "TOPLEFT",
            20,
        ...
        PetActionBarFrame:SetPoint(
            ...
            "TOPLEFT",
            20,
            MultiBarBottomLeft:IsShown() and 8 or -40
        )
        PetActionButton1:SetPoint(
            "BOTTOMLEFT",
            MultiBarBottomLeftButton1,
...
local AddBars = function()
    ...
    ns.BUBorder(
        ...
        MainMenuBarVehicleLeaveButton:GetWidth() - 10,
        MainMenuBarVehicleLeaveButton:GetWidth() - 2,
        3.5,
        6
    )
